...
async function WeatherPage(props: Props) {
    ...
    const generateWeatherSummary = async () => {
        ...
        try {
            ...
            // weatherSummary = "Unable to generate AI weather summary"
        } catch (error) {
            weatherSummary = "Unable to generate AI weather summary"
            console.error(error);
        }
